  ...
  if (
    ...
    if (empty($msg) && $verif_titre->rowCount() > 0 && empty($id_salle)) {
      ...
      if (empty($msg)) {
        ...
        $msg .= '<div class="alert alert-danger">La salle a bien été enregistrée</div>';
      }
    }
  }
}
...
<main role="main" class="container ">
  ...
  if (isset($_GET['action']) && $_GET['action'] == 'affichage') {
    ...
    while ($ligne = $liste_salle->fetch(PDO::FETCH_ASSOC)) {
      ...
      echo '<td><a  data-toggle="collapse" href="#description' . $ligne['id_salle'] . '" role="button" aria-expanded="false" aria-controls="collapseExample"> ' . htmlspecialchars(iconv_substr($ligne['description'], 0, 5), ENT_QUOTES, 'UTF-8') . ' ...</a>
      <div class="collapse" id="description' .$ligne['id_salle']. '">
  <div class="card card-body">' . htmlspecialchars($ligne['description'], ENT_QUOTES, 'UTF-8') . '
      ...
      echo '<td><a  data-toggle="collapse" href="#adresse' . $ligne['id_salle'] . '" role="button" aria-expanded="false" aria-controls="collapseExample"> ' . htmlspecialchars(iconv_substr($ligne['adresse'], 0, 15), ENT_QUOTES, 'UTF-8') . ' ...</a>
      <div class="collapse" id="adresse' .$ligne['id_salle']. '">
  <div class="card card-body">' . htmlspecialchars($ligne['adresse'], ENT_QUOTES, 'UTF-8') . '
